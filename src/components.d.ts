...
declare global {
  ...
  interface HTMLGxcfButtonEditElement extends Components.GxcfButtonEdit, HTMLStencilElement {}
...
declare module "@stencil/core" {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      'gxcf-button-edit': LocalJSX.GxcfButtonEdit & JSXBase.HTMLAttributes<HTMLGxcfButtonEditElement>;
